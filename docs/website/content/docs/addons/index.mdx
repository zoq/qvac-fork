...
| [`@qvac/tts-ggml`](/addons/tts-ggml) | Text-to-speech | Speech synthesis for text-to-speech (TTS). | [`qvac-tts.cpp`](https://github.com/tetherto/qvac-ext-lib-whisper.cpp/tree/master/tts-cpp) (GGML) | stable |
| [`@qvac/audiogen-ggml`](/addons/audiogen-ggml) | Music generation | Generate music from text, lyrics, and musical controls. | [ACE-Step 1.5](https://github.com/ace-step/ACE-Step-1.5) (GGML) | experimental |
| [`@qvac/ocr-ggml`](https://github.com/tetherto/qvac/tree/main/packages/ocr-ggml) | OCR | Optical character recognition (OCR) for extracting text from images. | GGML (EasyOCR and docTR pipelines on GGUF weights) | stable |
